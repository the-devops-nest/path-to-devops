...
- 🧠 Anyone wanting structured, real-world DevOps practice  
...
✅ Provision AWS infra using **Terraform**  
✅ Deploy & manage apps on **Kubernetes (EKS)** with **Helm**  
...
**Goal:** Learn AWS + Terraform for repeatable infra setup
...
- Combine Terraform modules into full app infra  
...
- K8s architecture, objects, and controllers  
- Deployments, Services, ConfigMaps, Secrets *(Lab)*  

#### 🧩 Weekend 2: EKS & Helm  
- Provisioning **EKS** or local cluster alternatives  
...
**Goal:** Secure pipelines, automate delivery, and build your final project
...
- GitOps, multi-env pipelines, rollback strategies  
...
- Integrate **Code → CI/CD → Infra → EKS → Monitoring**  
...
A guided, end-to-end DevOps delivery pipeline:
